...
export default class SignUp extends Component {
  ...
  render() {
    ...
    const closeFrameElement = () =>{

      // alert()

      const closeFrameElement = document.getElementById("hello");
      const closeMain = document.getElementById("main_div");
    ...
    return (
      ...
      <div className=" container card p-3 w-25">
